<template>
  <div class="navbar">
    ...
    <breadcrumb id="breadcrumb-container" class="breadcrumb-container" v-if="!getters.topNav" />
    <top-nav id="topmenu-container" class="topmenu-container" v-if="getters.topNav" />
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <router-link to="/user/profile">
                <el-dropdown-item>个人中心 {{getters.topNav}}</el-dropdown-item>
              </router-link>
...
const getters = computed(() => appStore);
